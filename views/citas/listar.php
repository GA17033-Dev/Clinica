                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span class="badge rounded-pill <?php
                                                                            echo $row['estado_cita'] == 'programada' ? 'bg-primary-subtle text-primary' : ($row['estado_cita'] == 'completada' ? 'bg-success-subtle text-success' : 'bg-danger-subtle text-danger');
                                                                            ?>">
                                                <i class="bi <?php
                                                                echo $row['estado_cita'] == 'programada' ? 'bi-calendar-check' : ($row['estado_cita'] == 'completada' ? 'bi-check-circle' : 'bi-x-circle');
                                                                ?> me-1"></i>
